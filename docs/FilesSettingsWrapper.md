...
------------ | ------------- | ------------- | -------------
**response** | [**FilesSettingsDto**](FilesSettingsDto.md) | The FilesSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FilesSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FilesSettingsWrapper = {
    response,
    count,
    links,
    status,
