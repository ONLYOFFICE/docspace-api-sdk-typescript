...
------------ | ------------- | ------------- | -------------
**response** | [**FileUploadResultDto**](FileUploadResultDto.md) | The FileUploadResultDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FileUploadResultWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FileUploadResultWrapper = {
    response,
    count,
    links,
    status,
