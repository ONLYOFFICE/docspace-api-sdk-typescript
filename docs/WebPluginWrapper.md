...
------------ | ------------- | ------------- | -------------
**response** | [**WebPluginDto**](WebPluginDto.md) | The WebPluginDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { WebPluginWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: WebPluginWrapper = {
    response,
    count,
    links,
    status,
