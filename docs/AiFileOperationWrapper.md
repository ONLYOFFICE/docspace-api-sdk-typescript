...
------------ | ------------- | ------------- | -------------
**response** | [**AiFileOperationDto**](AiFileOperationDto.md) | The FileOperationDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiFileOperationWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiFileOperationWrapper = {
    response,
    count,
    links,
    status,
