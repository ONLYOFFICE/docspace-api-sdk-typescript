...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;SecurityDto&gt;**](SecurityDto.md) | The list of SecurityDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { SecurityArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: SecurityArrayWrapper = {
    response,
    count,
    links,
    status,
