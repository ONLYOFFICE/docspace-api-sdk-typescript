...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;ProviderSettingsDto&gt;**](ProviderSettingsDto.md) |  | [optional] [default to undefined]
...
```typescript
import { ProviderSettingsArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ProviderSettingsArrayWrapper = {
    response,
    count,
    links,
    status,
