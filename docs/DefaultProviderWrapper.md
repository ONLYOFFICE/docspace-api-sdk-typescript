...
------------ | ------------- | ------------- | -------------
**response** | [**DefaultProviderDto**](DefaultProviderDto.md) |  | [optional] [default to undefined]
...
```typescript
import { DefaultProviderWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DefaultProviderWrapper = {
    response,
    count,
    links,
    status,
