...
------------ | ------------- | ------------- | -------------
**response** | [**EncryptionSettings**](EncryptionSettings.md) | The EncryptionSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { EncryptionSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: EncryptionSettingsWrapper = {
    response,
    count,
    links,
    status,
