...
------------ | ------------- | ------------- | -------------
**response** | [**TenantQuotaSettings**](TenantQuotaSettings.md) | The TenantQuotaSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TenantQuotaSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TenantQuotaSettingsWrapper = {
    response,
    count,
    links,
    status,
