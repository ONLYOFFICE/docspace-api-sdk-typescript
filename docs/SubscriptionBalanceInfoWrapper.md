...
------------ | ------------- | ------------- | -------------
**response** | [**SubscriptionBalanceInfo**](SubscriptionBalanceInfo.md) | The SubscriptionBalanceInfo object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { SubscriptionBalanceInfoWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: SubscriptionBalanceInfoWrapper = {
    response,
    count,
    links,
    status,
