...
------------ | ------------- | ------------- | -------------
**response** | [**DocsCloudConfig**](DocsCloudConfig.md) |  | [optional] [default to undefined]
...
```typescript
import { DocsCloudConfigWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DocsCloudConfigWrapper = {
    response,
    count,
    links,
    status,
