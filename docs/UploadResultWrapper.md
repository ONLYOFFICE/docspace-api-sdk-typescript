...
------------ | ------------- | ------------- | -------------
**response** | [**UploadResultDto**](UploadResultDto.md) | The UploadResultDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { UploadResultWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: UploadResultWrapper = {
    response,
    count,
    links,
    status,
