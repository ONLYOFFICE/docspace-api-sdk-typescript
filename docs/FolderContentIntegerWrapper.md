...
------------ | ------------- | ------------- | -------------
**response** | [**FolderContentDtoInteger**](FolderContentDtoInteger.md) | The FolderContentDtoInteger object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FolderContentIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FolderContentIntegerWrapper = {
    response,
    count,
    links,
    status,
