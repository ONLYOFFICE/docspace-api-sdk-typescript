...
------------ | ------------- | ------------- | -------------
**response** | [**FireBaseUser**](FireBaseUser.md) | The FireBaseUser object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FireBaseUserWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FireBaseUserWrapper = {
    response,
    count,
    links,
    status,
