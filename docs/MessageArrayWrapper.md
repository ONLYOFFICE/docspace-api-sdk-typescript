...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;MessageDto&gt;**](MessageDto.md) |  | [optional] [default to undefined]
...
```typescript
import { MessageArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: MessageArrayWrapper = {
    response,
    count,
    links,
    status,
