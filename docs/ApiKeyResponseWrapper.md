...
------------ | ------------- | ------------- | -------------
**response** | [**ApiKeyResponseDto**](ApiKeyResponseDto.md) | The ApiKeyResponseDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ApiKeyResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ApiKeyResponseWrapper = {
    response,
    count,
    links,
    status,
