...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;WebhooksLogDto&gt;**](WebhooksLogDto.md) | The list of WebhooksLogDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { WebhooksLogArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: WebhooksLogArrayWrapper = {
    response,
    count,
    links,
    status,
