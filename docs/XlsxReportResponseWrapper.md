...
------------ | ------------- | ------------- | -------------
**response** | [**XlsxReportResponseDto**](XlsxReportResponseDto.md) | The XlsxReportResponseDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { XlsxReportResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: XlsxReportResponseWrapper = {
    response,
    count,
    links,
    status,
