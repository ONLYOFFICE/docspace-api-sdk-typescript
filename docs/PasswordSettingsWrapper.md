...
------------ | ------------- | ------------- | -------------
**response** | [**PasswordSettingsDto**](PasswordSettingsDto.md) | The PasswordSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { PasswordSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: PasswordSettingsWrapper = {
    response,
    count,
    links,
    status,
