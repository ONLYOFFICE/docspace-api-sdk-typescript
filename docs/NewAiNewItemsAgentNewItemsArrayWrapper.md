...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;NewAiNewItemsDtoAgentNewItemsDto&gt;**](NewAiNewItemsDtoAgentNewItemsDto.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiNewItemsAgentNewItemsArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiNewItemsAgentNewItemsArrayWrapper = {
    response,
    count,
    links,
    status,
