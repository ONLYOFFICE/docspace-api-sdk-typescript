...
**triggers** | [**WebhookTrigger**](WebhookTrigger.md) | The webhook trigger type. | [optional] [default to undefined]
**targetId** | **string** | The webhook target ID. | [optional] [default to undefined]
**createdBy** | [**EmployeeDto**](EmployeeDto.md) | The user who created the webhook. | [optional] [default to undefined]
**createdOn** | **string** | The date and time when the webhook was created. | [optional] [default to undefined]
**modifiedBy** | [**EmployeeDto**](EmployeeDto.md) | The user who modified the webhook. | [optional] [default to undefined]
