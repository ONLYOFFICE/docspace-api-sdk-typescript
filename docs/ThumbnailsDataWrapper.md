...
------------ | ------------- | ------------- | -------------
**response** | [**ThumbnailsDataDto**](ThumbnailsDataDto.md) | The ThumbnailsDataDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ThumbnailsDataWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ThumbnailsDataWrapper = {
    response,
    count,
    links,
    status,
