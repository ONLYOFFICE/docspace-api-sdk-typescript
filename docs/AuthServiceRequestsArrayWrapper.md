...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;AuthServiceRequestsDto&gt;**](AuthServiceRequestsDto.md) | The list of AuthServiceRequestsDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AuthServiceRequestsArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AuthServiceRequestsArrayWrapper = {
    response,
    count,
    links,
    status,
