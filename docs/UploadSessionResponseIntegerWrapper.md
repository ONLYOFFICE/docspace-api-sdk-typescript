...
------------ | ------------- | ------------- | -------------
**response** | [**UploadSessionResponseDtoInteger**](UploadSessionResponseDtoInteger.md) | The UploadSessionResponseDtoInteger object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { UploadSessionResponseIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: UploadSessionResponseIntegerWrapper = {
    response,
    count,
    links,
    status,
