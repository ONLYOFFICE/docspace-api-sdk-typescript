...
------------ | ------------- | ------------- | -------------
**response** | [**AiAiSettingsDto**](AiAiSettingsDto.md) | The AiSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiAiSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiAiSettingsWrapper = {
    response,
    count,
    links,
    status,
