...
------------ | ------------- | ------------- | -------------
**response** | [**IsDefaultWhiteLabelLogosDto**](IsDefaultWhiteLabelLogosDto.md) | The IsDefaultWhiteLabelLogosDto object returned by the operation. | [optional] [default to undefined]
