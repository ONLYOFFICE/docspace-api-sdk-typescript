...
------------ | ------------- | ------------- | -------------
**response** | [**RoomSecurityDto**](RoomSecurityDto.md) | The RoomSecurityDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { RoomSecurityWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: RoomSecurityWrapper = {
    response,
    count,
    links,
    status,
