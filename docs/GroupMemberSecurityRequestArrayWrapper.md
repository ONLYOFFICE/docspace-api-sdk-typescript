...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;GroupMemberSecurityRequestDto&gt;**](GroupMemberSecurityRequestDto.md) | The list of GroupMemberSecurityRequestDto objects returned by the operation. | [optional] [default to undefined]
