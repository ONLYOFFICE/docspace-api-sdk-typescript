...
------------ | ------------- | ------------- | -------------
**response** | [**DocsCloudUsage**](DocsCloudUsage.md) | The DocsCloudUsage object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DocsCloudUsageWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DocsCloudUsageWrapper = {
    response,
    count,
    links,
    status,
