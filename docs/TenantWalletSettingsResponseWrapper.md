...
------------ | ------------- | ------------- | -------------
**response** | [**TenantWalletSettings**](TenantWalletSettings.md) | The TenantWalletSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TenantWalletSettingsResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TenantWalletSettingsResponseWrapper = {
    response,
    count,
    links,
    status,
