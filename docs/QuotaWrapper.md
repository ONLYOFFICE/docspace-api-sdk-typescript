...
------------ | ------------- | ------------- | -------------
**response** | [**QuotaDto**](QuotaDto.md) | The QuotaDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { QuotaWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: QuotaWrapper = {
    response,
    count,
    links,
    status,
