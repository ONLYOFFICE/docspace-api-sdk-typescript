...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;AccountInfoDto&gt;**](AccountInfoDto.md) | The list of AccountInfoDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AccountInfoArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AccountInfoArrayWrapper = {
    response,
    count,
    links,
    status,
