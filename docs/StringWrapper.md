...
------------ | ------------- | ------------- | -------------
**response** | **string** | The string value returned by the operation. | [optional] [default to undefined]
...
```typescript
import { StringWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: StringWrapper = {
    response,
    count,
    links,
    status,
