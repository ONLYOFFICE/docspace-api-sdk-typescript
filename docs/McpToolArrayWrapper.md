...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;McpToolDto&gt;**](McpToolDto.md) |  | [optional] [default to undefined]
...
```typescript
import { McpToolArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: McpToolArrayWrapper = {
    response,
    count,
    links,
    status,
