...
------------ | ------------- | ------------- | -------------
**response** | [**ConfirmDto**](ConfirmDto.md) | The ConfirmDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ConfirmWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ConfirmWrapper = {
    response,
    count,
    links,
    status,
