...
------------ | ------------- | ------------- | -------------
**response** | [**UserExistsResponseDto**](UserExistsResponseDto.md) | The UserExistsResponseDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { UserExistsResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: UserExistsResponseWrapper = {
    response,
    count,
    links,
    status,
