...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;TimezonesRequestsDto&gt;**](TimezonesRequestsDto.md) | The list of TimezonesRequestsDto objects returned by the operation. | [optional] [default to undefined]
