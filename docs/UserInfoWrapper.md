...
------------ | ------------- | ------------- | -------------
**response** | [**UserInfo**](UserInfo.md) | The UserInfo object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { UserInfoWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: UserInfoWrapper = {
    response,
    count,
    links,
    status,
