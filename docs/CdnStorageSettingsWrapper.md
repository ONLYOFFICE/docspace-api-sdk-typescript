...
------------ | ------------- | ------------- | -------------
**response** | [**CdnStorageSettings**](CdnStorageSettings.md) | The CdnStorageSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CdnStorageSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CdnStorageSettingsWrapper = {
    response,
    count,
    links,
    status,
