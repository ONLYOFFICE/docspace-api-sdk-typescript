...
------------ | ------------- | ------------- | -------------
**response** | [**NewAiFolderDtoInteger**](NewAiFolderDtoInteger.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiFolderIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiFolderIntegerWrapper = {
    response,
    count,
    links,
    status,
