...
------------ | ------------- | ------------- | -------------
**additions** | [**NewAiWatermarkAdditions**](NewAiWatermarkAdditions.md) |  | [default to undefined]
...
```typescript
import { NewAiWatermarkDto } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiWatermarkDto = {
    additions,
    text,
    rotate,
    imageScale,
