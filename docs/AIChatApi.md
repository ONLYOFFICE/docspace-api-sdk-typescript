...
# **exportChat**
> exportChat(exportChatRequestBodyInteger)
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **exportChatRequestBodyInteger** | **ExportChatRequestBodyInteger**| The export parameters including destination folder and file title. | |
...
let exportChatRequestBodyInteger: ExportChatRequestBodyInteger; //The export parameters including destination folder and file title.
