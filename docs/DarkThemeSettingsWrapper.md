...
------------ | ------------- | ------------- | -------------
**response** | [**DarkThemeSettings**](DarkThemeSettings.md) | The DarkThemeSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DarkThemeSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DarkThemeSettingsWrapper = {
    response,
    count,
    links,
    status,
