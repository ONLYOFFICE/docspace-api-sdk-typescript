...
------------ | ------------- | ------------- | -------------
**response** | [**NotificationSettingsDto**](NotificationSettingsDto.md) | The NotificationSettingsDto object returned by the operation. | [optional] [default to undefined]
