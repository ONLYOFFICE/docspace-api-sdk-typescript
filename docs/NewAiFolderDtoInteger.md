...
**access** | [**NewAiFileShare**](NewAiFileShare.md) |  | [optional] [default to undefined]
**sharedBy** | [**NewAiEmployeeDto**](NewAiEmployeeDto.md) |  | [optional] [default to undefined]
**ownedBy** | [**NewAiEmployeeDto**](NewAiEmployeeDto.md) |  | [optional] [default to undefined]
...
**created** | [**NewAiApiDateTime**](NewAiApiDateTime.md) |  | [optional] [default to undefined]
**createdBy** | [**NewAiEmployeeDto**](NewAiEmployeeDto.md) |  | [optional] [default to undefined]
**updated** | [**NewAiApiDateTime**](NewAiApiDateTime.md) |  | [optional] [default to undefined]
**autoDelete** | [**NewAiApiDateTime**](NewAiApiDateTime.md) |  | [optional] [default to undefined]
**rootFolderType** | [**NewAiFolderType**](NewAiFolderType.md) |  | [optional] [default to undefined]
**parentRoomType** | [**NewAiFolderType**](NewAiFolderType.md) |  | [optional] [default to undefined]
**updatedBy** | [**NewAiEmployeeDto**](NewAiEmployeeDto.md) |  | [optional] [default to undefined]
...
**fileEntryType** | [**NewAiFileEntryType**](NewAiFileEntryType.md) |  | [optional] [default to undefined]
...
**expirationDate** | [**NewAiApiDateTime**](NewAiApiDateTime.md) |  | [optional] [default to undefined]
...
**logo** | [**NewAiLogo**](NewAiLogo.md) |  | [optional] [default to undefined]
**pinned** | **boolean** | Specifies if the folder is pinned or not. | [optional] [default to undefined]
**roomType** | [**NewAiRoomType**](NewAiRoomType.md) |  | [optional] [default to undefined]
...
**lifetime** | [**NewAiRoomDataLifetimeDto**](NewAiRoomDataLifetimeDto.md) |  | [optional] [default to undefined]
**watermark** | [**NewAiWatermarkDto**](NewAiWatermarkDto.md) |  | [optional] [default to undefined]
**type** | [**NewAiFolderType**](NewAiFolderType.md) |  | [optional] [default to undefined]
...
**chatSettings** | [**NewAiChatSettingsDto**](NewAiChatSettingsDto.md) |  | [optional] [default to undefined]
**rootRoomType** | [**NewAiRoomType**](NewAiRoomType.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiFolderDtoInteger } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiFolderDtoInteger = {
    title,
    access,
    sharedBy,
    ownedBy,
