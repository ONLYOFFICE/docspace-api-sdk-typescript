...
------------ | ------------- | ------------- | -------------
**response** | [**CompanyWhiteLabelSettings**](CompanyWhiteLabelSettings.md) | The CompanyWhiteLabelSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CompanyWhiteLabelSettingsResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CompanyWhiteLabelSettingsResponseWrapper = {
    response,
    count,
    links,
    status,
