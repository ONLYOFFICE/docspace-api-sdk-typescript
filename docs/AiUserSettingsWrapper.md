...
------------ | ------------- | ------------- | -------------
**response** | [**AiUserSettingsDto**](AiUserSettingsDto.md) |  | [optional] [default to undefined]
...
```typescript
import { AiUserSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiUserSettingsWrapper = {
    response,
    count,
    links,
    status,
