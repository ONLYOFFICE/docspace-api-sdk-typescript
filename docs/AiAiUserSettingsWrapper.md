...
------------ | ------------- | ------------- | -------------
**response** | [**AiAiUserSettingsDto**](AiAiUserSettingsDto.md) | The AiUserSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiAiUserSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiAiUserSettingsWrapper = {
    response,
    count,
    links,
    status,
