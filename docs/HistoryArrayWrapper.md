...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;HistoryDto&gt;**](HistoryDto.md) | The list of HistoryDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { HistoryArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: HistoryArrayWrapper = {
    response,
    count,
    links,
    status,
