...
------------ | ------------- | ------------- | -------------
**response** | [**AiFolderDtoInteger**](AiFolderDtoInteger.md) | The FolderDtoInteger object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiFolderIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiFolderIntegerWrapper = {
    response,
    count,
    links,
    status,
