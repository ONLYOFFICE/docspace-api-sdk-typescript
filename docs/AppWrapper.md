...
------------ | ------------- | ------------- | -------------
**response** | [**AppDto**](AppDto.md) | The AppDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AppWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AppWrapper = {
    response,
    count,
    links,
    status,
