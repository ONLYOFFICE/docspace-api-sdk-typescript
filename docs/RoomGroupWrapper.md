...
------------ | ------------- | ------------- | -------------
**response** | [**RoomGroupDto**](RoomGroupDto.md) | The RoomGroupDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { RoomGroupWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: RoomGroupWrapper = {
    response,
    count,
    links,
    status,
