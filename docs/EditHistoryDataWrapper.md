...
The successful API response containing the EditHistoryDataDto object.

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**response** | [**EditHistoryDataDto**](EditHistoryDataDto.md) | The EditHistoryDataDto object returned by the operation. | [optional] [default to undefined]
