...
------------ | ------------- | ------------- | -------------
**response** | [**TenantAiAccessSettings**](TenantAiAccessSettings.md) | The TenantAiAccessSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TenantAiAccessSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TenantAiAccessSettingsWrapper = {
    response,
    count,
    links,
    status,
