...
------------ | ------------- | ------------- | -------------
**response** | [**ActiveConnectionsDto**](ActiveConnectionsDto.md) | The ActiveConnectionsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ActiveConnectionsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ActiveConnectionsWrapper = {
    response,
    count,
    links,
    status,
