...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;TfaSettingsDto&gt;**](TfaSettingsDto.md) | The list of TfaSettingsDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TfaSettingsArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TfaSettingsArrayWrapper = {
    response,
    count,
    links,
    status,
