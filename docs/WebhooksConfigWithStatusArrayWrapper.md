...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;WebhooksConfigWithStatusDto&gt;**](WebhooksConfigWithStatusDto.md) | The list of WebhooksConfigWithStatusDto objects returned by the operation. | [optional] [default to undefined]
