...
------------ | ------------- | ------------- | -------------
**response** | [**FolderDtoInteger**](FolderDtoInteger.md) | The FolderDtoInteger object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FolderIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FolderIntegerWrapper = {
    response,
    count,
    links,
    status,
