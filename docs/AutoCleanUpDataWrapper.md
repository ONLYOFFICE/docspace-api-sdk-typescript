...
------------ | ------------- | ------------- | -------------
**response** | [**AutoCleanUpData**](AutoCleanUpData.md) | The AutoCleanUpData object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AutoCleanUpDataWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AutoCleanUpDataWrapper = {
    response,
    count,
    links,
    status,
