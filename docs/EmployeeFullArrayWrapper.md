...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;EmployeeFullDto&gt;**](EmployeeFullDto.md) | The list of EmployeeFullDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { EmployeeFullArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: EmployeeFullArrayWrapper = {
    response,
    count,
    links,
    status,
