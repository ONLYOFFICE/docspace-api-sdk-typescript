...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;QuotaDto&gt;**](QuotaDto.md) | The list of QuotaDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { QuotaArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: QuotaArrayWrapper = {
    response,
    count,
    links,
    status,
