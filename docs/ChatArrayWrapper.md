...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;ChatDto&gt;**](ChatDto.md) |  | [optional] [default to undefined]
...
```typescript
import { ChatArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ChatArrayWrapper = {
    response,
    count,
    links,
    status,
