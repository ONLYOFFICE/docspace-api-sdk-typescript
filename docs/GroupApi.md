...
|[**getByUserId**](#getbyuserid) | **GET** /api/2.0/group/user/{userid} | Get user groups|
...
|[**setManager**](#setmanager) | **PUT** /api/2.0/group/{id}/manager | Set a group manager|
|[**setMembersTo**](#setmembersto) | **POST** /api/2.0/group/{id}/members | Replace group members|
|[**transferMembersTo**](#transfermembersto) | **PUT** /api/2.0/group/{fromId}/members/{toId} | Move group members|
...
# **getByUserId**
> GroupSummaryArrayWrapper getByUserId()
...
const { status, data } = await apiInstance.setManager(
    id,
    setManagerRequest
);
```
...
# **transferMembersTo**
> GroupWrapper transferMembersTo()
...
const { status, data } = await apiInstance.transferMembersTo(
    fromId,
    toId
);
```
