...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;TfaAppCodeDto&gt;**](TfaAppCodeDto.md) | The list of TfaAppCodeDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TfaAppCodeArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TfaAppCodeArrayWrapper = {
    response,
    count,
    links,
    status,
