...
------------ | ------------- | ------------- | -------------
**response** | [**DocsCloudTenant**](DocsCloudTenant.md) | The DocsCloudTenant object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DocsCloudTenantWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DocsCloudTenantWrapper = {
    response,
    count,
    links,
    status,
