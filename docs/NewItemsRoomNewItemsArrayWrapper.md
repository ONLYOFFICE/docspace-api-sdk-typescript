...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;NewItemsDtoRoomNewItemsDto&gt;**](NewItemsDtoRoomNewItemsDto.md) | The list of NewItemsDtoRoomNewItemsDto objects returned by the operation. | [optional] [default to undefined]
