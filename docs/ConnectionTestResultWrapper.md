...
------------ | ------------- | ------------- | -------------
**response** | [**ConnectionTestResult**](ConnectionTestResult.md) |  | [optional] [default to undefined]
...
```typescript
import { ConnectionTestResultWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ConnectionTestResultWrapper = {
    response,
    count,
    links,
    status,
