...
------------ | ------------- | ------------- | -------------
**response** | [**PaymentCalculation**](PaymentCalculation.md) | The PaymentCalculation object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { PaymentCalculationWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: PaymentCalculationWrapper = {
    response,
    count,
    links,
    status,
