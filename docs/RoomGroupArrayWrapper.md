...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;RoomGroupDto&gt;**](RoomGroupDto.md) | The list of RoomGroupDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { RoomGroupArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: RoomGroupArrayWrapper = {
    response,
    count,
    links,
    status,
