...
------------ | ------------- | ------------- | -------------
**response** | [**Tariff**](Tariff.md) | The Tariff object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TariffWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TariffWrapper = {
    response,
    count,
    links,
    status,
