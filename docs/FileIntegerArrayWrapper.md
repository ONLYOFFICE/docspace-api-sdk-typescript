...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;FileDtoInteger&gt;**](FileDtoInteger.md) | The list of FileDtoInteger objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FileIntegerArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FileIntegerArrayWrapper = {
    response,
    count,
    links,
    status,
