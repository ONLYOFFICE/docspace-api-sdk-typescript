...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;AppDto&gt;**](AppDto.md) | The list of AppDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AppArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AppArrayWrapper = {
    response,
    count,
    links,
    status,
