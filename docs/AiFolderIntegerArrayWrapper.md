...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;AiFolderDtoInteger&gt;**](AiFolderDtoInteger.md) | The list of FolderDtoInteger objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiFolderIntegerArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiFolderIntegerArrayWrapper = {
    response,
    count,
    links,
    status,
