...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;NewAiFolderDtoInteger&gt;**](NewAiFolderDtoInteger.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiFolderIntegerArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiFolderIntegerArrayWrapper = {
    response,
    count,
    links,
    status,
