...
The successful API response containing the FileShareDto object.

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**response** | [**FileShareDto**](FileShareDto.md) | The FileShareDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FileShareWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FileShareWrapper = {
    response,
    count,
    links,
    status,
