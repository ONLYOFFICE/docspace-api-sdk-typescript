...
------------ | ------------- | ------------- | -------------
**response** | [**NewAiAiUserSettingsDto**](NewAiAiUserSettingsDto.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiAiUserSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiAiUserSettingsWrapper = {
    response,
    count,
    links,
    status,
