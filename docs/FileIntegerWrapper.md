...
------------ | ------------- | ------------- | -------------
**response** | [**FileDtoInteger**](FileDtoInteger.md) | The FileDtoInteger object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FileIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FileIntegerWrapper = {
    response,
    count,
    links,
    status,
