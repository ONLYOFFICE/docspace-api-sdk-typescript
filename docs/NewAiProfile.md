...
**providerType** | [**NewAiProviderType**](NewAiProviderType.md) |  | [default to undefined]
**basedOn** | [**NewAiBuiltinProviderType**](NewAiBuiltinProviderType.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiProfile } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiProfile = {
    id,
    name,
    providerType,
    basedOn,
