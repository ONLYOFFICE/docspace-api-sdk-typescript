...
------------ | ------------- | ------------- | -------------
**response** | [**CustomerInfoDto**](CustomerInfoDto.md) | The CustomerInfoDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CustomerInfoWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CustomerInfoWrapper = {
    response,
    count,
    links,
    status,
