...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;McpServerShortDto&gt;**](McpServerShortDto.md) |  | [optional] [default to undefined]
...
```typescript
import { McpServerShortArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: McpServerShortArrayWrapper = {
    response,
    count,
    links,
    status,
