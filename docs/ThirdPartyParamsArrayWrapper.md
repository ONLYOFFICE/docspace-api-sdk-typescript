...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;ThirdPartyParams&gt;**](ThirdPartyParams.md) | The list of ThirdPartyParams objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ThirdPartyParamsArrayWrapper } from '@onlyoffice/docspace-api-sdk';
