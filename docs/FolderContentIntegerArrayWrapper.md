...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;FolderContentDtoInteger&gt;**](FolderContentDtoInteger.md) | The list of FolderContentDtoInteger objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FolderContentIntegerArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FolderContentIntegerArrayWrapper = {
    response,
    count,
    links,
    status,
