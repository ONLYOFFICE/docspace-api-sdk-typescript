...
------------ | ------------- | ------------- | -------------
**response** | [**AiVectorizationSettingsDto**](AiVectorizationSettingsDto.md) | The VectorizationSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiVectorizationSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiVectorizationSettingsWrapper = {
    response,
    count,
    links,
    status,
