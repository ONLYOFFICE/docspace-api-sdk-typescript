...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;EditHistoryDto&gt;**](EditHistoryDto.md) | The list of EditHistoryDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { EditHistoryArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: EditHistoryArrayWrapper = {
    response,
    count,
    links,
    status,
