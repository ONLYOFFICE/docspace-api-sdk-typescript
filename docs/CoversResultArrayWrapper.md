...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;CoversResultDto&gt;**](CoversResultDto.md) | The list of CoversResultDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CoversResultArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CoversResultArrayWrapper = {
    response,
    count,
    links,
    status,
