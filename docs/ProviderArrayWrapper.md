...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;ProviderDto&gt;**](ProviderDto.md) | The list of ProviderDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ProviderArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ProviderArrayWrapper = {
    response,
    count,
    links,
    status,
