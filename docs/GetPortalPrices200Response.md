...
------------ | ------------- | ------------- | -------------
**response** | **{ [key: string]: number; }** | The response payload. | [optional] [default to undefined]
...
```typescript
import { GetPortalPrices200Response } from '@onlyoffice/docspace-api-sdk';

const instance: GetPortalPrices200Response = {
    response,
    count,
    links,
    status,
