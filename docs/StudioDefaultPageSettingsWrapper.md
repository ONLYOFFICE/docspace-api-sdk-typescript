...
------------ | ------------- | ------------- | -------------
**response** | [**StudioDefaultPageSettings**](StudioDefaultPageSettings.md) | The StudioDefaultPageSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { StudioDefaultPageSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: StudioDefaultPageSettingsWrapper = {
    response,
    count,
    links,
    status,
