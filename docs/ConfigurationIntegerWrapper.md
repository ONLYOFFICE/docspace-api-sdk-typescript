...
------------ | ------------- | ------------- | -------------
**response** | [**ConfigurationDtoInteger**](ConfigurationDtoInteger.md) | The ConfigurationDtoInteger object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ConfigurationIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ConfigurationIntegerWrapper = {
    response,
    count,
    links,
    status,
