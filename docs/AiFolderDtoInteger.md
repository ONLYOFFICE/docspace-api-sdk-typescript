...
**expirationDate** | [**AiApiDateTime**](AiApiDateTime.md) |  | [optional] [default to undefined]
...
**logo** | [**AiLogo**](AiLogo.md) |  | [optional] [default to undefined]
**pinned** | **boolean** | Specifies if the folder is pinned or not. | [optional] [default to undefined]
**roomType** | [**AiRoomType**](AiRoomType.md) |  | [optional] [default to undefined]
...
**lifetime** | [**AiRoomDataLifetimeDto**](AiRoomDataLifetimeDto.md) |  | [optional] [default to undefined]
**watermark** | [**AiWatermarkDto**](AiWatermarkDto.md) |  | [optional] [default to undefined]
**type** | [**AiFolderType**](AiFolderType.md) |  | [optional] [default to undefined]
...
**chatSettings** | [**AiChatSettingsDto**](AiChatSettingsDto.md) |  | [optional] [default to undefined]
**rootRoomType** | [**AiRoomType**](AiRoomType.md) |  | [optional] [default to undefined]
