...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;ApiKeyResponseDto&gt;**](ApiKeyResponseDto.md) | The list of ApiKeyResponseDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ApiKeyResponseArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ApiKeyResponseArrayWrapper = {
    response,
    count,
    links,
    status,
