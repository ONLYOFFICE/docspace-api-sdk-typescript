...
------------ | ------------- | ------------- | -------------
**response** | [**CustomerServiceUsageReportDto**](CustomerServiceUsageReportDto.md) | The CustomerServiceUsageReportDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CustomerServiceUsageReportWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CustomerServiceUsageReportWrapper = {
    response,
    count,
    links,
    status,
