...
------------ | ------------- | ------------- | -------------
**response** | [**NewAiAiSettingsDto**](NewAiAiSettingsDto.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiAiSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiAiSettingsWrapper = {
    response,
    count,
    links,
    status,
