...
------------ | ------------- | ------------- | -------------
**response** | [**TenantUserQuotaSettings**](TenantUserQuotaSettings.md) | The TenantUserQuotaSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TenantUserQuotaSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TenantUserQuotaSettingsWrapper = {
    response,
    count,
    links,
    status,
