...
------------ | ------------- | ------------- | -------------
**response** | [**GeneratedFileDto**](GeneratedFileDto.md) |  | [optional] [default to undefined]
...
```typescript
import { GeneratedFileWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: GeneratedFileWrapper = {
    response,
    count,
    links,
    status,
