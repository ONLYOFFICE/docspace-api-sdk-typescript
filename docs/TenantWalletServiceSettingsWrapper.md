...
------------ | ------------- | ------------- | -------------
**response** | [**TenantWalletServiceSettings**](TenantWalletServiceSettings.md) | The TenantWalletServiceSettings object returned by the operation. | [optional] [default to undefined]
