...
------------ | ------------- | ------------- | -------------
**response** | [**NewAiFolderContentDtoInteger**](NewAiFolderContentDtoInteger.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiFolderContentIntegerWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiFolderContentIntegerWrapper = {
    response,
    count,
    links,
    status,
