...
------------ | ------------- | ------------- | -------------
**response** | [**SettingsDto**](SettingsDto.md) | The SettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { SettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: SettingsWrapper = {
    response,
    count,
    links,
    status,
