...
------------ | ------------- | ------------- | -------------
**response** | [**MigrationStatusDto**](MigrationStatusDto.md) | The MigrationStatusDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { MigrationStatusWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: MigrationStatusWrapper = {
    response,
    count,
    links,
    status,
