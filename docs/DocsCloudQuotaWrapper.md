...
------------ | ------------- | ------------- | -------------
**response** | [**DocsCloudQuota**](DocsCloudQuota.md) | The DocsCloudQuota object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DocsCloudQuotaWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DocsCloudQuotaWrapper = {
    response,
    count,
    links,
    status,
