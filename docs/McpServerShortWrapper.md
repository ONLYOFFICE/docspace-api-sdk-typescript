...
------------ | ------------- | ------------- | -------------
**response** | [**McpServerShortDto**](McpServerShortDto.md) |  | [optional] [default to undefined]
...
```typescript
import { McpServerShortWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: McpServerShortWrapper = {
    response,
    count,
    links,
    status,
