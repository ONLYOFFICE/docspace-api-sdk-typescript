...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;CompanyWhiteLabelSettings&gt;**](CompanyWhiteLabelSettings.md) | The list of CompanyWhiteLabelSettings objects returned by the operation. | [optional] [default to undefined]
