...
------------ | ------------- | ------------- | -------------
**response** | [**TfaSetupCodeDto**](TfaSetupCodeDto.md) | The TfaSetupCodeDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TfaSetupCodeWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TfaSetupCodeWrapper = {
    response,
    count,
    links,
    status,
