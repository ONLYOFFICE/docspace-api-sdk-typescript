...
------------ | ------------- | ------------- | -------------
**response** | [**WalletServiceDto**](WalletServiceDto.md) | The WalletServiceDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { WalletServiceWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: WalletServiceWrapper = {
    response,
    count,
    links,
    status,
