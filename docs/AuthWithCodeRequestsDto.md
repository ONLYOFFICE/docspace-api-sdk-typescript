...
**confirmData** | [**ConfirmData**](ConfirmData.md) | The additional confirmation data required for authentication. | [optional] [default to undefined]
...
```typescript
import { AuthWithCodeRequestsDto } from '@onlyoffice/docspace-api-sdk';

const instance: AuthWithCodeRequestsDto = {
    userName,
    password,
    passwordHash,
    provider,
