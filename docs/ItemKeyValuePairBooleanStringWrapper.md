...
------------ | ------------- | ------------- | -------------
**response** | [**ItemKeyValuePairBooleanString**](ItemKeyValuePairBooleanString.md) | The ItemKeyValuePairBooleanString object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ItemKeyValuePairBooleanStringWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ItemKeyValuePairBooleanStringWrapper = {
    response,
    count,
    links,
    status,
