...
------------ | ------------- | ------------- | -------------
**response** | [**DefaultTemplateSettingsDto**](DefaultTemplateSettingsDto.md) | The DefaultTemplateSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DefaultTemplateSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DefaultTemplateSettingsWrapper = {
    response,
    count,
    links,
    status,
