...
------------ | ------------- | ------------- | -------------
**response** | [**InvitationLinkDto**](InvitationLinkDto.md) | The InvitationLinkDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { InvitationLinkWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: InvitationLinkWrapper = {
    response,
    count,
    links,
    status,
