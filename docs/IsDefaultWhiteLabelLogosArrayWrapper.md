...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;IsDefaultWhiteLabelLogosDto&gt;**](IsDefaultWhiteLabelLogosDto.md) | The list of IsDefaultWhiteLabelLogosDto objects returned by the operation. | [optional] [default to undefined]
