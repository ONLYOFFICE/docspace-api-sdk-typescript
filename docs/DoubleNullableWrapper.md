...
------------ | ------------- | ------------- | -------------
**response** | **number** | The double value returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DoubleNullableWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DoubleNullableWrapper = {
    response,
    count,
    links,
    status,
