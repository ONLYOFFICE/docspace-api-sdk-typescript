...
------------ | ------------- | ------------- | -------------
**response** | [**AiPricesResponse**](AiPricesResponse.md) | The AiPricesResponse object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiPricesResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiPricesResponseWrapper = {
    response,
    count,
    links,
    status,
