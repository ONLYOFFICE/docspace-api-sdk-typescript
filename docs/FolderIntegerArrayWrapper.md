...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;FolderDtoInteger&gt;**](FolderDtoInteger.md) | The list of FolderDtoInteger objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FolderIntegerArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FolderIntegerArrayWrapper = {
    response,
    count,
    links,
    status,
