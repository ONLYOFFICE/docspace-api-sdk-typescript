...
------------ | ------------- | ------------- | -------------
**response** | [**WebhooksLogDto**](WebhooksLogDto.md) | The WebhooksLogDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { WebhooksLogWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: WebhooksLogWrapper = {
    response,
    count,
    links,
    status,
