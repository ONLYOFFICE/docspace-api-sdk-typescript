...
------------ | ------------- | ------------- | -------------
**response** | [**TenantQuota**](TenantQuota.md) | The TenantQuota object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TenantQuotaWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TenantQuotaWrapper = {
    response,
    count,
    links,
    status,
