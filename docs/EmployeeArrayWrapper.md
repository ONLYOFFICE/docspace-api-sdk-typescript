...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;EmployeeDto&gt;**](EmployeeDto.md) | The list of EmployeeDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { EmployeeArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: EmployeeArrayWrapper = {
    response,
    count,
    links,
    status,
