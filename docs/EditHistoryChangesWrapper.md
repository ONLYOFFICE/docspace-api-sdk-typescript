...
------------ | ------------- | ------------- | -------------
**user** | [**EditHistoryAuthor**](EditHistoryAuthor.md) | The user who edited the file. | [optional] [default to undefined]
**created** | **string** | The creation date and time of the file version. | [optional] [default to undefined]
