...
------------ | ------------- | ------------- | -------------
**response** | [**CapabilitiesDto**](CapabilitiesDto.md) | The CapabilitiesDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CapabilitiesWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CapabilitiesWrapper = {
    response,
    count,
    links,
    status,
