...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;UpcomingPaymentDto&gt;**](UpcomingPaymentDto.md) | The list of UpcomingPaymentDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { UpcomingPaymentArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: UpcomingPaymentArrayWrapper = {
    response,
    count,
    links,
    status,
