...
------------ | ------------- | ------------- | -------------
**response** | [**ServicePayment**](ServicePayment.md) |  | [optional] [default to undefined]
...
```typescript
import { ServicePaymentWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ServicePaymentWrapper = {
    response,
    count,
    links,
    status,
