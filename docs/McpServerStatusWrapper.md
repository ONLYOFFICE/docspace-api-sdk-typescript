...
------------ | ------------- | ------------- | -------------
**response** | [**McpServerStatusDto**](McpServerStatusDto.md) |  | [optional] [default to undefined]
...
```typescript
import { McpServerStatusWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: McpServerStatusWrapper = {
    response,
    count,
    links,
    status,
