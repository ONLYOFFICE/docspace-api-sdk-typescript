...
**roomType** | [**RoomType**](RoomType.md) | The third-party room type to be created. | [default to undefined]
...
**logo** | [**LogoRequest**](LogoRequest.md) | The logo request parameters of the third-party room. | [optional] [default to undefined]
