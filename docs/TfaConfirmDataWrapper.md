...
------------ | ------------- | ------------- | -------------
**response** | [**TfaConfirmDataDto**](TfaConfirmDataDto.md) | The TfaConfirmDataDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TfaConfirmDataWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TfaConfirmDataWrapper = {
    response,
    count,
    links,
    status,
