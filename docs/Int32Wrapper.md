...
------------ | ------------- | ------------- | -------------
**response** | **number** | The int32 value returned by the operation. | [optional] [default to undefined]
...
```typescript
import { Int32Wrapper } from '@onlyoffice/docspace-api-sdk';

const instance: Int32Wrapper = {
    response,
    count,
    links,
    status,
