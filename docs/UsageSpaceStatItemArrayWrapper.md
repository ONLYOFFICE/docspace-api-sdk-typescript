...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;UsageSpaceStatItemDto&gt;**](UsageSpaceStatItemDto.md) | The list of UsageSpaceStatItemDto objects returned by the operation. | [optional] [default to undefined]
