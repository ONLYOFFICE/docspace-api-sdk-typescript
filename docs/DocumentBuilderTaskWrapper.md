...
------------ | ------------- | ------------- | -------------
**response** | [**DocumentBuilderTaskDto**](DocumentBuilderTaskDto.md) | The DocumentBuilderTaskDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DocumentBuilderTaskWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DocumentBuilderTaskWrapper = {
    response,
    count,
    links,
    status,
