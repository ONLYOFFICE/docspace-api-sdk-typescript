...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;ModelSettingsDto&gt;**](ModelSettingsDto.md) |  | [optional] [default to undefined]
...
```typescript
import { ModelSettingsArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ModelSettingsArrayWrapper = {
    response,
    count,
    links,
    status,
