...
------------ | ------------- | ------------- | -------------
**response** | [**FileReference**](FileReference.md) | The FileReference object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FileReferenceWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FileReferenceWrapper = {
    response,
    count,
    links,
    status,
