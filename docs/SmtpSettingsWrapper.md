...
------------ | ------------- | ------------- | -------------
**response** | [**SmtpSettingsDto**](SmtpSettingsDto.md) | The SmtpSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { SmtpSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: SmtpSettingsWrapper = {
    response,
    count,
    links,
    status,
