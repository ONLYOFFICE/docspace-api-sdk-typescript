...
------------ | ------------- | ------------- | -------------
**response** | [**FileEntryBaseDto**](FileEntryBaseDto.md) | The FileEntryBaseDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FileEntryBaseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FileEntryBaseWrapper = {
    response,
    count,
    links,
    status,
