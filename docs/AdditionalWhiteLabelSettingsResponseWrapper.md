...
------------ | ------------- | ------------- | -------------
**response** | [**AdditionalWhiteLabelSettings**](AdditionalWhiteLabelSettings.md) | The AdditionalWhiteLabelSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AdditionalWhiteLabelSettingsResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AdditionalWhiteLabelSettingsResponseWrapper = {
    response,
    count,
    links,
    status,
