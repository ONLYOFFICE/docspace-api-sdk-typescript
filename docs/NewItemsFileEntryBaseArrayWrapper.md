...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;NewItemsDtoFileEntryBaseDto&gt;**](NewItemsDtoFileEntryBaseDto.md) | The list of NewItemsDtoFileEntryBaseDto objects returned by the operation. | [optional] [default to undefined]
