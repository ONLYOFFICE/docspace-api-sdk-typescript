...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;CurrenciesDto&gt;**](CurrenciesDto.md) | The list of CurrenciesDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CurrenciesArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CurrenciesArrayWrapper = {
    response,
    count,
    links,
    status,
