...
**defaultOrder** | [**OrderBy**](OrderBy.md) | The default order of files. | [optional] [default to undefined]
...
**automaticallyCleanUp** | [**AutoCleanUpData**](AutoCleanUpData.md) | The auto-clearing setting parameters. | [optional] [default to undefined]
