...
------------ | ------------- | ------------- | -------------
**additions** | [**AiWatermarkAdditions**](AiWatermarkAdditions.md) | Specifies whether to display in the watermark: username, user email, user ip-adress, current date, and room name. | [default to undefined]
