...
------------ | ------------- | ------------- | -------------
**response** | [**NewAiFileOperationDto**](NewAiFileOperationDto.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiFileOperationWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiFileOperationWrapper = {
    response,
    count,
    links,
    status,
