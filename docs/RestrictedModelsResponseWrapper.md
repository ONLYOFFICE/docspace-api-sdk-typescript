...
------------ | ------------- | ------------- | -------------
**response** | [**RestrictedModelsResponse**](RestrictedModelsResponse.md) | The RestrictedModelsResponse object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { RestrictedModelsResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: RestrictedModelsResponseWrapper = {
    response,
    count,
    links,
    status,
