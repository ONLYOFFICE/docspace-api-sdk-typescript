...
------------ | ------------- | ------------- | -------------
**response** | [**FilesStatisticsResultDto**](FilesStatisticsResultDto.md) | The FilesStatisticsResultDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FilesStatisticsResultWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FilesStatisticsResultWrapper = {
    response,
    count,
    links,
    status,
