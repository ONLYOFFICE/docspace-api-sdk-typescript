...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;FileEntryDtoInteger&gt;**](FileEntryDtoInteger.md) | The list of FileEntryDtoInteger objects returned by the operation. | [optional] [default to undefined]
