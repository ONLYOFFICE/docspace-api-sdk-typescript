...
------------ | ------------- | ------------- | -------------
**response** | [**FormSubmissionsDto**](FormSubmissionsDto.md) | The FormSubmissionsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FormSubmissionsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FormSubmissionsWrapper = {
    response,
    count,
    links,
    status,
