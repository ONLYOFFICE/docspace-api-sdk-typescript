...
------------ | ------------- | ------------- | -------------
**response** | [**LoginSettingsDto**](LoginSettingsDto.md) | The LoginSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { LoginSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: LoginSettingsWrapper = {
    response,
    count,
    links,
    status,
