...
------------ | ------------- | ------------- | -------------
**referenceData** | [**FileReferenceData**](FileReferenceData.md) | An object that is generated by the integrator to uniquely identify a file in its system. | [optional] [default to undefined]
