...
------------ | ------------- | ------------- | -------------
**response** | [**ExternalDbSyncTaskDto**](ExternalDbSyncTaskDto.md) | The ExternalDbSyncTaskDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { ExternalDbSyncTaskWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ExternalDbSyncTaskWrapper = {
    response,
    count,
    links,
    status,
