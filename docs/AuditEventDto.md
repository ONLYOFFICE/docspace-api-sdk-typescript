...
**date** | **string** | The audit event date. | [optional] [default to undefined]
...
**actionId** | [**MessageAction**](MessageAction.md) | The specific action that occurred within the audit event. | [optional] [default to undefined]
...
**actionType** | [**ActionType**](ActionType.md) | The type of action performed in the audit event (e.g., Create, Update, Delete). | [optional] [default to undefined]
**product** | [**ProductType**](ProductType.md) | The type of product related to the audit event. | [optional] [default to undefined]
**location** | [**LocationType**](LocationType.md) | The location where the audit event occurred. | [optional] [default to undefined]
