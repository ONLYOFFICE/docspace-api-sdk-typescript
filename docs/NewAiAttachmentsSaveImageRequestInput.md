# NewAiAttachmentsSaveImageRequestInput
...
```typescript
import { NewAiAttachmentsSaveImageRequestInput } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiAttachmentsSaveImageRequestInput = {
    name,
    base64,
    title,
};
