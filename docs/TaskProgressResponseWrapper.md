...
------------ | ------------- | ------------- | -------------
**response** | [**TaskProgressResponseDto**](TaskProgressResponseDto.md) | The TaskProgressResponseDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TaskProgressResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TaskProgressResponseWrapper = {
    response,
    count,
    links,
    status,
