...
------------ | ------------- | ------------- | -------------
**response** | [**CspDto**](CspDto.md) | The CspDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { CspWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: CspWrapper = {
    response,
    count,
    links,
    status,
