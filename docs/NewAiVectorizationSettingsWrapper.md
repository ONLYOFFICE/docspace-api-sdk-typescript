...
------------ | ------------- | ------------- | -------------
**response** | [**NewAiVectorizationSettingsDto**](NewAiVectorizationSettingsDto.md) |  | [optional] [default to undefined]
...
```typescript
import { NewAiVectorizationSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: NewAiVectorizationSettingsWrapper = {
    response,
    count,
    links,
    status,
