...
------------ | ------------- | ------------- | -------------
**response** | [**RoomsNotificationSettingsDto**](RoomsNotificationSettingsDto.md) | The RoomsNotificationSettingsDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { RoomsNotificationSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: RoomsNotificationSettingsWrapper = {
    response,
    count,
    links,
    status,
