...
------------ | ------------- | ------------- | -------------
**response** | [**EncryptionKeyDto**](EncryptionKeyDto.md) |  | [optional] [default to undefined]
...
```typescript
import { EncryptionKeyWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: EncryptionKeyWrapper = {
    response,
    count,
    links,
    status,
