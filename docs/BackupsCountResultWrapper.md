...
------------ | ------------- | ------------- | -------------
**response** | [**BackupsCountResultDto**](BackupsCountResultDto.md) | The BackupsCountResultDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { BackupsCountResultWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: BackupsCountResultWrapper = {
    response,
    count,
    links,
    status,
