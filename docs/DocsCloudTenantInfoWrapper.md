...
------------ | ------------- | ------------- | -------------
**response** | [**DocsCloudTenantInfo**](DocsCloudTenantInfo.md) | The DocsCloudTenantInfo object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DocsCloudTenantInfoWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DocsCloudTenantInfoWrapper = {
    response,
    count,
    links,
    status,
