...
------------ | ------------- | ------------- | -------------
**response** | [**FolderDtoString**](FolderDtoString.md) | The FolderDtoString object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FolderStringWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FolderStringWrapper = {
    response,
    count,
    links,
    status,
