...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;AiNewItemsDtoAgentNewItemsDto&gt;**](AiNewItemsDtoAgentNewItemsDto.md) | The list of NewItemsDtoAgentNewItemsDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { AiNewItemsAgentNewItemsArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: AiNewItemsAgentNewItemsArrayWrapper = {
    response,
    count,
    links,
    status,
