...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;MentionWrapper&gt;**](MentionWrapper.md) | The list of MentionWrapper objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { MentionWrapperArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: MentionWrapperArrayWrapper = {
    response,
    count,
    links,
    status,
