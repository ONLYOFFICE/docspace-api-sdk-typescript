...
The successful API response containing the DocServiceUrlDto object.

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**response** | [**DocServiceUrlDto**](DocServiceUrlDto.md) | The DocServiceUrlDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { DocServiceUrlWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: DocServiceUrlWrapper = {
    response,
    count,
    links,
    status,
