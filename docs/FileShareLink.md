...
**expirationDate** | **string** | The date when the shared link expires. | [optional] [default to undefined]
**linkType** | [**LinkType**](LinkType.md) | The sharing link type (e.g., Invitation). | [optional] [default to undefined]
