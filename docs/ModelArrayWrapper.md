...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;ModelDto&gt;**](ModelDto.md) |  | [optional] [default to undefined]
...
```typescript
import { ModelArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: ModelArrayWrapper = {
    response,
    count,
    links,
    status,
