...
------------ | ------------- | ------------- | -------------
**response** | [**GroupDto**](GroupDto.md) | The GroupDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { GroupWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: GroupWrapper = {
    response,
    count,
    links,
    status,
