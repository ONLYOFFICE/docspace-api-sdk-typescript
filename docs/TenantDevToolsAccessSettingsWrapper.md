...
------------ | ------------- | ------------- | -------------
**response** | [**TenantDevToolsAccessSettings**](TenantDevToolsAccessSettings.md) | The TenantDevToolsAccessSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TenantDevToolsAccessSettingsWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TenantDevToolsAccessSettingsWrapper = {
    response,
    count,
    links,
    status,
