...
------------ | ------------- | ------------- | -------------
**response** | [**FileEncryptionInfoDto**](FileEncryptionInfoDto.md) | The FileEncryptionInfoDto object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { FileEncryptionInfoWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: FileEncryptionInfoWrapper = {
    response,
    count,
    links,
    status,
