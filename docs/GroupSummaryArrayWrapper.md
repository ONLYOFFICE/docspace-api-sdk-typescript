...
------------ | ------------- | ------------- | -------------
**response** | [**Array&lt;GroupSummaryDto&gt;**](GroupSummaryDto.md) | The list of GroupSummaryDto objects returned by the operation. | [optional] [default to undefined]
...
```typescript
import { GroupSummaryArrayWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: GroupSummaryArrayWrapper = {
    response,
    count,
    links,
    status,
