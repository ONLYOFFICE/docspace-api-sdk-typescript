...
------------ | ------------- | ------------- | -------------
**response** | [**TenantAuditSettings**](TenantAuditSettings.md) | The TenantAuditSettings object returned by the operation. | [optional] [default to undefined]
...
```typescript
import { TenantAuditSettingsResponseWrapper } from '@onlyoffice/docspace-api-sdk';

const instance: TenantAuditSettingsResponseWrapper = {
    response,
    count,
    links,
    status,
