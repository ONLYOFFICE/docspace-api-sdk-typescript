...
// @ts-ignore
import type { FormResultsArrayWrapper } from '../../models';
// @ts-ignore
...
export const FilesFilesApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async addFileToRecent(fileId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileIntegerWrapper>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['FilesFilesApi.addFileToRecent']?.[localVarOperationServerIndex]?.url;
        ...
        async createFilePrimaryExternalLink(id: number, fileLinkRequest: FileLinkRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileShareWrapper>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['FilesFilesApi.createFilePrimaryExternalLink']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Creates an HTML (.html) file in the selected folder with the title and contents specified in the request.
         ...
         * @see https://api.onlyoffice.com/docspace/api-backend/usage-api/get-form-submissions/
         */
        async getFormSubmissions(fileId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FormResultsArrayWrapper>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getFormSubmissions(fileId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['FilesFilesApi.getFormSubmissions']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Returns a link to download a file with the ID specified in the request asynchronously.
        ...
        async setFileExternalLink(id: number, fileLinkRequest: FileLinkRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileShareWrapper>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['FilesFilesApi.setFileExternalLink']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Sets the order of the file with the ID specified in the request.
        ...
        async toggleFileFavorite(fileId: number, favorite?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BooleanWrapper>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['FilesFilesApi.toggleFileFavorite']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Tracks file changes when editing.
...
export const FilesFilesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createEditSession(fileId: number, fileSize?: number, options?: RawAxiosRequestConfig): AxiosPromise<ChunkedUploadSessionResponseWrapperIntegerWrapper> {
         ...
         * @throws {RequiredError}
         */
        getFormSubmissions(fileId: number, options?: RawAxiosRequestConfig): AxiosPromise<FormResultsArrayWrapper> {
            return localVarFp.getFormSubmissions(fileId, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a link to download a file with the ID specified in the request asynchronously.
         * @summary Get file download link asynchronously
         ...
         * @throws {RequiredError}
         */
        saveFormRoleMapping(fileId: string, saveFormRoleMappingDtoInteger?: SaveFormRoleMappingDtoInteger, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        toggleFileFavorite(fileId: number, favorite?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<BooleanWrapper> {
            return localVarFp.toggleFileFavorite(fileId, favorite, options).then((request) => request(axios, basePath));
        },
        /**
         * Tracks file changes when editing.
         * @summary Track file editing
...
export class FilesFilesApi extends BaseAPI {
    ...
    public addFileToRecent(fileId: number, options?: RawAxiosRequestConfig) {
        return FilesFilesApiFp(this.configuration).addFileToRecent(fileId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public createFilePrimaryExternalLink(id: number, fileLinkRequest: FileLinkRequest, options?: RawAxiosRequestConfig) {
        return FilesFilesApiFp(this.configuration).createFilePrimaryExternalLink(id, fileLinkRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FilesFilesApi
     */
    public getFormSubmissions(fileId: number, options?: RawAxiosRequestConfig) {
        return FilesFilesApiFp(this.configuration).getFormSubmissions(fileId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public setFileExternalLink(id: number, fileLinkRequest: FileLinkRequest, options?: RawAxiosRequestConfig) {
        return FilesFilesApiFp(this.configuration).setFileExternalLink(id, fileLinkRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FilesFilesApi
     */
    public toggleFileFavorite(fileId: number, favorite?: boolean, options?: RawAxiosRequestConfig) {
        return FilesFilesApiFp(this.configuration).toggleFileFavorite(fileId, favorite, options).then((request) => request(this.axios, this.basePath));
    }
