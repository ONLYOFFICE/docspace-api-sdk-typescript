...
export const SettingsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async changeDownloadZipFromBody(displayRequestDto?: DisplayRequestDto, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ICompressWrapper>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['SettingsApi.changeDownloadZipFromBody']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Changes the Access Control external sharing settings.
...
export const SettingsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        changeDefaultAccessRights(requestParameters: SettingsApiChangeDefaultAccessRightsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<FileShareArrayWrapper> {
         ...
         * Changes the format of the downloaded archive from .zip to .tar.gz. This method uses the body parameters.
         * @summary Change the archive format (using body parameters)
         * @param {SettingsApiChangeDownloadZipFromBodyRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * REST API Reference for changeDownloadZipFromBody operation
         * @see https://api.onlyoffice.com/docspace/api-backend/usage-api/change-download-zip-from-body/
         * @throws {RequiredError}
         */
        changeDownloadZipFromBody(requestParameters: SettingsApiChangeDownloadZipFromBodyRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ICompressWrapper> {
...
/**
 * Request parameters for changeDownloadZipFromBody operation in SettingsApi.
 * @export
 * @interface SettingsApiChangeDownloadZipFromBodyRequest
 */
export interface SettingsApiChangeDownloadZipFromBodyRequest {
    /**
     * 
     * @type {DisplayRequestDto}
     * @memberof SettingsApiChangeDownloadZipFromBody
     */
...
export class SettingsApi extends BaseAPI {
     ...
     * @memberof SettingsApi
     */
    public changeDownloadZipFromBody(requestParameters: SettingsApiChangeDownloadZipFromBodyRequest = {}, options?: RawAxiosRequestConfig) {
        return SettingsApiFp(this.configuration).changeDownloadZipFromBody(requestParameters.displayRequestDto, options).then((request) => request(this.axios, this.basePath));
    }
