...
export const ThirdPartyApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getCodeRequest: async (provider: LoginProvider, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'provider' is not null or undefined
            assertParamExists('getCodeRequest', 'provider', provider)
...
export const ThirdPartyApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCodeRequest(provider: LoginProvider, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ObjectWrapper>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCodeRequest(provider, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ThirdPartyApi.getCodeRequest']?.[localVarOperationServerIndex]?.url;
...
export const ThirdPartyApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getCodeRequest(provider: LoginProvider, options?: RawAxiosRequestConfig): AxiosPromise<ObjectWrapper> {
            return localVarFp.getCodeRequest(provider, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ThirdPartyApi extends BaseAPI {
     ...
     */
    public getCodeRequest(provider: LoginProvider, options?: RawAxiosRequestConfig) {
        return ThirdPartyApiFp(this.configuration).getCodeRequest(provider, options).then((request) => request(this.axios, this.basePath));
    }
}
