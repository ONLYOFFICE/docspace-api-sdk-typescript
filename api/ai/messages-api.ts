...
// @ts-ignore
import type { ExportMessageRequestBody } from '../../models';
/**
...
export const MessagesApiAxiosParamCreator = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @param {ExportMessageRequestBody} exportMessageRequestBody The export parameters including destination folder and file title.
         ...
         */
        exportMessage: async (messageId: number, exportMessageRequestBody: ExportMessageRequestBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'messageId' is not null or undefined
            assertParamExists('exportMessage', 'messageId', messageId)
            // verify required parameter 'exportMessageRequestBody' is not null or undefined
            assertParamExists('exportMessage', 'exportMessageRequestBody', exportMessageRequestBody)
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(exportMessageRequestBody, localVarRequestOptions, configuration)
...
export const MessagesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @see https://api.onlyoffice.com/docspace/api-backend/usage-api/export-message/
         */
        async exportMessage(messageId: number, exportMessageRequestBody: ExportMessageRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.exportMessage(messageId, exportMessageRequestBody, options);
...
export const MessagesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        exportMessage(requestParameters: MessagesApiExportMessageRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.exportMessage(requestParameters.messageId, requestParameters.exportMessageRequestBody, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface MessagesApiExportMessageRequest {
     ...
     * @type {ExportMessageRequestBody}
     * @memberof MessagesApiExportMessage
     */
    readonly exportMessageRequestBody: ExportMessageRequestBody
}
...
export class MessagesApi extends BaseAPI {
    ...
    public exportMessage(requestParameters: MessagesApiExportMessageRequest, options?: RawAxiosRequestConfig) {
        return MessagesApiFp(this.configuration).exportMessage(requestParameters.messageId, requestParameters.exportMessageRequestBody, options).then((request) => request(this.axios, this.basePath));
    }
}
