 ...
 */
export interface NewAiChatEvent {
    /**
...
export const NewAiChatEventTypeEnum = {
...
export type NewAiChatEventTypeEnum = typeof NewAiChatEventTypeEnum[keyof typeof NewAiChatEventTypeEnum];
