...
// @ts-ignore
import type { AiToolsBulkResultErrorsInner } from './ai-tools-bulk-result-errors-inner';
 ...
 */
export interface AiToolsBulkResult {
    /**
     ...
     */
    'errors'?: Array<AiToolsBulkResultErrorsInner>;
}
