...
// @ts-ignore
import type { NewAiDistributedTaskStatus } from './new-ai-distributed-task-status';
// May contain unused imports in some cases
// @ts-ignore
import type { NewAiFileEntryBaseDto } from './new-ai-file-entry-base-dto';
// May contain unused imports in some cases
// @ts-ignore
import type { NewAiFileOperationType } from './new-ai-file-operation-type';

/**
 * The file operation information.
 */
export interface NewAiFileOperationDto {
    /**
    ...
    'status'?: NewAiDistributedTaskStatus;
}
