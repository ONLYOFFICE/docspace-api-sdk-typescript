...
export const MessageAction = {
    ...
    */
    AgentDeleted: 5156,
    /**
    * MCP server added to agent
    */
    AddedServerToAgent: 5157,
    /**
    * MCP server deleted from agent
    */
    ...
    */
    ServerDeleted: 6080,
    /**
    * WebSearch settings configured
    */
    SetWebSearchSettings: 6081,
    /**
    * WebSearch settings reset
    */
    ResetWebSearchSettings: 6082,
    /**
    * Vectorization settings configured
    */
    SetVectorizationSettings: 6083,
    /**
    * Vectorization settings reset
    */
