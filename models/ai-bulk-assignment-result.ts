...
// @ts-ignore
import type { AiBulkAssignmentResultErrorsInner } from './ai-bulk-assignment-result-errors-inner';
 ...
 */
export interface AiBulkAssignmentResult {
    'success': boolean;
    'errors'?: Array<AiBulkAssignmentResultErrorsInner>;
}
