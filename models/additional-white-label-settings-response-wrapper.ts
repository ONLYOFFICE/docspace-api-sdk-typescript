 ...
 */
export interface AdditionalWhiteLabelSettingsResponseWrapper {
    /**
     * The AdditionalWhiteLabelSettings object returned by the operation.
     */
    'response'?: AdditionalWhiteLabelSettings;
    /**
